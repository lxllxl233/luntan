 ...
 * @since 2020-05-23
 */
@ApiModel(value="TbBlogCatalogV2对象", description="")
public class TbBlogCatalogV2 implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "博客二级分类的id")
    ...
    public TbBlogCatalogV2(Integer id, String name) {
        this.id = id;
        this.name = name;
    }

    public TbBlogCatalogV2(String name, Integer v1Id) {
        this.id = 0;
        this.name = name;
        this.v1Id = v1Id;
    }
