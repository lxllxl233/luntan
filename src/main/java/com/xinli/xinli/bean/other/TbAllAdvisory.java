...
public class TbAllAdvisory {
    ...
    private TbMasterEntity masterConsultantEntity;
    private TbMasterEntity masterSupervisorEntity;
    private TbApplicationEntity tbApplicationEntity;
    ...
    @OneToOne
    public TbMasterEntity getMasterConsultantEntity() {
        return masterConsultantEntity;
    }

    public void setMasterConsultantEntity(TbMasterEntity masterConsultantEntity) {
        this.masterConsultantEntity = masterConsultantEntity;
    }

    @JoinColumn(name = "master_supervisor_id",insertable = false,updatable = false)
    @OneToOne
    public TbMasterEntity getMasterSupervisorEntity() {
        return masterSupervisorEntity;
    }

    public void setMasterSupervisorEntity(TbMasterEntity masterSupervisorEntity) {
        this.masterSupervisorEntity = masterSupervisorEntity;
    }

    @JoinColumn(name = "app_id",insertable = false,updatable = false)
    @OneToOne
    public TbApplicationEntity getTbApplicationEntity() {
        return tbApplicationEntity;
    }

    public void setTbApplicationEntity(TbApplicationEntity tbApplicationEntity) {
        this.tbApplicationEntity = tbApplicationEntity;
    }
